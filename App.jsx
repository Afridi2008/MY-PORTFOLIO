...
import profilePhoto from './src/imgs/photo copy.jpg';
import billerImg from './src/imgs/biller.png';
import siratImg from './src/imgs/sirat.png';
import krImg from './src/imgs/kr.jpeg';
import periodicImg from './src/imgs/periodic.png';
import cgpaImg from './src/imgs/cgpa.png';
import casioImg from './src/imgs/casio.png';
      ...
      <div className="navbar-fixed-wrap">
        <nav className="navbar" aria-label="Main Navigation">
          ...
          <ul className="nav-links">
            <li><a href="#hero" className={`nav-link-item ${activeSection === 'hero' ? 'active' : ''}`} onClick={(e) => { e.preventDefault(); scrollToSection('hero'); }}>Home</a></li>
            <li><a href="#about" className={`nav-link-item ${activeSection === 'about' ? 'active' : ''}`} onClick={(e) => { e.preventDefault(); scrollToSection('about'); }}>About</a></li>
            <li><a href="#education" className={`nav-link-item ${activeSection === 'education' ? 'active' : ''}`} onClick={(e) => { e.preventDefault(); scrollToSection('education'); }}>Education</a></li>
            <li><a href="#skills" className={`nav-link-item ${activeSection === 'skills' ? 'active' : ''}`} onClick={(e) => { e.preventDefault(); scrollToSection('skills'); }}>Skills</a></li>
            <li><a href="#projects" className={`nav-link-item ${activeSection === 'projects' ? 'active' : ''}`} onClick={(e) => { e.preventDefault(); scrollToSection('projects'); }}>Projects</a></li>
            <li><a href="#certifications" className={`nav-link-item ${activeSection === 'certifications' ? 'active' : ''}`} onClick={(e) => { e.preventDefault(); scrollToSection('certifications'); }}>Certifications</a></li>
            <li><a href="#contact" className={`nav-link-item ${activeSection === 'contact' ? 'active' : ''}`} onClick={(e) => { e.preventDefault(); scrollToSection('contact'); }}>Contact</a></li>
          </ul>

          <button className="nav-cta-btn" onClick={() => scrollToSection('contact')}>
